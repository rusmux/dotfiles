...
config.window_background_image = os.getenv('HOME') .. '/Documents/Wallpapers/light.jpg'
...
config.colors = { scrollbar_thumb = 'rgb(234,234,234)' }
-- config.colors = { scrollbar_thumb = 'rgb(25,25,25)' }
